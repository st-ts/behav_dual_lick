...
tr_per_cond = 60; % total number will be x6

%% Sequence of stimulation
left = 1; right = -1;
seq_laser = repmat([0 0 left right], 1, tr_per_cond)';
cond_mult = 4;
tr_total = cond_mult * tr_per_cond;
permut_order = randperm(tr_total);
seq_laser = seq_laser(permut_order);

%% Variables to help out the poor mousie
max_conseq_to_move = 3;
max_conseq_to_force = 10;
max_missed = 2;
enforce = 0;
